...
void printDateTime()
{
    ...
    //todo: I should work on parsing the date for the logger, epoch time maybe,
    //todo: or standard time and date would work also. remember to add 1900 to 
    //todo: the year variable.
